      ...
      >
        ...
        >
          ...
          <PartGroup
            ...
            onFixed={(g) => {
              // 位置が確定していることを確認
              console.log(`${g.getPivotPositionForParent(this.state.pivot)}, ${this.state.g2_position})`);
              assert(pointsEqual(g.getPivotPositionForParent(this.state.pivot), this.state.g2_position))
            }}
          >
            <RectPart
